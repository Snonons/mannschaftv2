...
final class Banner {
    ...
    // http://patorjk.com/software/taag/#p=display&f=Slant&t=mannschaft%20v1
    ...
    private static final String SERVICE_PORT = System.getenv("MANNSCHAFT_SERVICE_PORT");
    private static final String KUBERNETES = SERVICE_HOST == null
        ? "N/A"
        : STR."MANNSCHAFT_SERVICE_HOST=\{SERVICE_HOST}, MANNSCHAFT_SERVICE_PORT=\{SERVICE_PORT}";
