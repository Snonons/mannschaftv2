...
| Name | Email | Url |
| ---- | ------ | --- |
| Jens Martin | <maje1024@h-ka.de> | <https://www.h-ka.de> |
...
| datasource.url | string | `"jdbc:postgresql://localhost/mannschaft"` |  |
| datasource.username | string | `"mannschaft"` |  |
...
| image.name | string | `"mannschaft"` | Name des Image |
| image.pullPolicy | string | `"Always"` | Pull-Policy für das Image |
| image.repository | string | `"jensmartin"` | Repository als Präfix beim Image-Namen |
